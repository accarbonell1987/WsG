...
class ListarPacientes extends React.Component{
    ...
    componentDidMount () {             // Esto se ejecuta despues que se monto el componente.
        ...
        this.wsLisPacientes.onclose = () => {
            console.log('wsLisPacientes desconectado con el Backend WsG')
                ...
                <>                        
                    <div className="mainDiv" style={{ width: '90%' }}>
                        <Alert variant='secondary' >
                            ...
                            <h3 className='centrado'>Bienvenido Dr. {this.state.tmpDoctor[0].Nombre}  {this.state.tmpDoctor[0].Apellidos} </h3>
                                    ...
                                    <Alert className="alertmargin" variant='secondary'>                                                   
                                        <table className="alingTablasCentro" >
                                            <tr >
                                                ...
                                                <th>  
                                                    <div style={{ height: '70px'}} className="btn btn-dark btn-block">                         
                                                        <img className="alingTablasfilas" onClick={(e)=>this.accionSalir()} src={process.env.PUBLIC_URL + '/logout2.png'} />
                                                        <span className="alingTablasfilas" onClick={(e)=>this.accionSalir()}>Salir Sesión</span>  
                                                    </div>
                                                </th>                                            
                                            </tr >
                                        </table> 
